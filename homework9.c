   ...
   /***************/
      ...
      while ( room < 3 ) /* Explore the maze */
      {
         if ( room == 0 )
         {
            ...
            printf("Enter 0 for flagstone, or 1 for air vent, or 2 for a tunnel  "); 
            scanf("%d", &choice); 
            if ( choice == 0 ) { room = 3; }
            if ( choice == 1 ) { room = 1; }
            if ( choice == 2 ) { room = -1; }
        ...
        key = 1;
         ...
         else if ( room == 2 )
         {
            ...
            printf("The tunnel leads you to the ECE building.\n");
            printf("The office hour is packed and students are sitting on the floor.\n");
            printf("Enter 0 to leave the building, 1 to jump out of the window, 2 to ask TA where to go, or 3 to enter a random classroom  "); 
            scanf("%d", &choice); 
            if ( choice == 0 ) { room = 0; }
            if ( choice == 1 ) { room = 3; }
            if ( choice == 2 ) { room = 1; }
