...
; R5 contains current sum
            ...
            LD    R0,INITIA           ; initialize R0
            LD    R1,INPUT            ; R1 contains input number
            LD    R2,NEGONE           ; R2 contains -1, change the way of getting it
            ADD   R3,R1,R2            ; R3 contains input number -1
            ADD   R3,R3,R2           ; R3 contains input number -2, delete extra comma
...
INNERLOOP   ADD   R5,R5,R1            ; Increment sum
            ...
            LD    R5,INITIA            ; Clear R5 (previous sum) to 0, use the INITIA
            ADD   R3,R3,R2            ; Decrement outer count
            BRzp  OUTERLOOP           ; Branch to outer loop if outer count, change pz to zp
                                      ;   is positive or zero
...
INITIA     .FILL  x0000               ; Can be used to initialize registers
